...
```{r}
#Recuperando nombres para el mapa, pero no se si conviene 
...
#Se procederá a graficar: ver las posiciones de los países:
```{r}
...
plot(CountryFull,col=myColors[CountryFull$clustDIV], add=T,border="white")
```
